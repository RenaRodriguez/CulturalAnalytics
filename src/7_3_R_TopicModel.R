# Das ist das dritte aber am besten funktionierende TM
...
anno_df <- anno_df[anno_df$upos %in% c("NOUN", "ADJ"), ]
...
new_stopwords <- c("gott", "könig", "pharao", "not","o")


tokens_clean <- tokens_remove(tokens_clean, pattern = all_stopwords, padding = TRUE)
